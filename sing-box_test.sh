#!/bin/bash
# bash <(curl -fsSL https://raw.githubusercontent.com/Arthurlu0421/demo/refs/heads/main/sing-box_test.sh)
...
install_shortcut() {
 ...
 #!/usr/bin/env bash
bash <(curl -fsSL https://raw.githubusercontent.com/Arthurlu0421/demo/refs/heads/main/sing-box_test.sh) \$1
EOF
